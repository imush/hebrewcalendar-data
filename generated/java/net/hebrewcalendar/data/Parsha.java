...
public enum Parsha {
    ...
    LECH_LECHA("LECH_LECHA", "Lech Lecha", "לך לך", "Лех Леха", "Lech Lécha"),
    VAYERA("VAYERA", "Vayera", "וירא", "Вайера", "Vayéra"),
    CHAYEI_SARAH("CHAYEI_SARAH", "Chayei Sarah", "חיי שרה", "Хаей Сара", "'Hayé Sarah"),
    ...
    KI_TISA("KI_TISA", "Ki Tisa", "כי תשא", "Ки Тиса", "Ki Tissa"),
    ...
    ACHAREI_MOT("ACHAREI_MOT", "Acharei", "אחרי", "Ахарей", "Acharei"),
    ...
    KI_TEITZEI("KI_TEITZEI", "Ki Teitzei", "כי תצא", "Ки Тецэ", "Ki Tétsé"),
    ...
    Parsha(String key, String en, String he, String ru, String fr) {
        this.key = key;
        this.en = en;
        this.he = he;
        this.ru = ru;
