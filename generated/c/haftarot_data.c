...
static const char *const HC_TANACH_BOOK_NAMES[HC_BOOK_COUNT] = {
    ...
    [HC_BOOK_I_SAMUEL] = "I Samuel",
    [HC_BOOK_II_SAMUEL] = "II Samuel",
    [HC_BOOK_I_KINGS] = "I Kings",
    [HC_BOOK_II_KINGS] = "II Kings",
