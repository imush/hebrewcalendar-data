...
enum TanachBook {
  ...
  iSamuel('I_SAMUEL', 'Samuel I', 'שמואל א׳', 'Шмуэль I', 'Samuel I'),
  iiSamuel('II_SAMUEL', 'Samuel II', 'שמואל ב׳', 'Шмуэль II', 'Samuel II'),
  iKings('I_KINGS', 'Kings I', 'מלכים א׳', 'Мелахим I', 'Melakhim I'),
  iiKings('II_KINGS', 'Kings II', 'מלכים ב׳', 'Мелахим II', 'Melakhim II'),
